    ...
    <div class="main-content">
        ...
        <main>
            <form id="cadastroForm" action="../php/processa_cadastro_responsavel.php" method="POST">
                ...
                <input type="text" name="cpfs_alunos" placeholder="000.000.000-00, 111.111.111-11" required>
                <hr>
                ...
                <input type="hidden" name="imagem_base64_1" id="imagem_base64_1"><input type="hidden" name="imagem_base64_2" id="imagem_base64_2"><input type="hidden" name="imagem_base64_3" id="imagem_base64_3"><input type="hidden" name="imagem_base64_4" id="imagem_base64_4"><input type="hidden" name="imagem_base64_5" id="imagem_base64_5">
